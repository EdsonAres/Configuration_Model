...
using namespace std;
int nv;//numero de nodes da rede
long int iseed= -1024;
...
{  	//variaveis
	...
	nv= *std::max_element(lista_nt.begin(), lista_nt.end())+1;
	//a variavel clasgraf serve apenas para dizer se será produzido um grafo simples ou multigrafo
	int clasgraf; //escolha 1 para grafo simples e 2 para multigrafo
	cout<<"SELECT THE CLASS:"<<endl;
	cout<<"TYPE 1 FOR SIMPLE GRAPH"<<endl;
	cout<<"TYPE 2 FOR MULTI GRAPH"<<endl;
	cin>>clasgraf;
